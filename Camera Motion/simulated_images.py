...
img1 = cv2.imread("data/simulated-pair-of-images/frame0000.jpg")
img2 = cv2.imread("data/simulated-pair-of-images/frame0001.jpg")
...
plt.show()
cv2.imwrite('output_images/simulated-pair-of-images/img1_keypoints.jpg',img1_sift)

plt.imshow(img2_sift)
plt.title('Img2 Keypoints')
plt.show()
cv2.imwrite('output_images/simulated-pair-of-images/img2_keypoints.jpg',img2_sift)
...
plt.title('Matches')
plt.show()
cv2.imwrite('output_images/simulated-pair-of-images/matches.jpg',img3)
...
plt.show()
cv2.imwrite('output_images/simulated-pair-of-images/img1_epipolar.jpg',img1_epip)
...
plt.show()
cv2.imwrite('output_images/simulated-pair-of-images/img2_epipolar.jpg',img2_epip)
