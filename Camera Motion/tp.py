...
cv2.imwrite('img1_keypoints.jpg',img1_sift)
cv2.imwrite('img2_keypoints.jpg',img2_sift)
...
cv2.imwrite('img1_epipolar.jpg',img1_epip)
...
cv2.imwrite('img2_epipolar.jpg',img2_epip)
...
R = np.zeros((3,3))
t = np.zeros((3,1))
cv2.recoverPose(E, pts1, pts2, K, R, t, mask);